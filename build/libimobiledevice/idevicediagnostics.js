...
function getBatteryLevelFor(uid) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`${global_1.uidToNameDictionary[uid]} is at ${batteryLevel}%. Device ${IsCharging ? 'is' : 'is not'} charging.`);
...
function tryGetBatteryLevel(uid) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (++tryCounter < MAX_TRY_COUNT && (result = yield getBatteryLevelFor(uid)) === -1) {
            console.warn(`could not read battery level for ${global_1.uidToNameDictionary[uid]}... will try again (try count: ${tryCounter}/${MAX_TRY_COUNT})`);
